...
(async () => {
  ...
  const files = ['js/data.js', 'js/search.js', 'js/db.js', 'js/provider.js', 'js/store.js', 'js/geo.js', 'js/route.js', 'js/app.js'];
  const srcs = {};
  ...
  for (const f of ['js/data.js', 'js/search.js', 'js/db.js', 'js/provider.js', 'js/store.js', 'js/geo.js', 'js/route.js']) {
